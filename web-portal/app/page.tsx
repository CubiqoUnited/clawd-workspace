      ...
      <body>
        ...
        <section className="hero">
          <div className="container">
            <div className="hero-content">
              ...
              <a href="#features" className="cta-button">Start Building</a>
            </div>
          </div>
        </section>
        ...
        <section className="section">
          <div className="container" style={{textAlign: 'center'}}>
            ...
            <a href="#" className="cta-button" style={{background: 'linear-gradient(90deg, #10B981, #3B82F6)'}}>
              Get Started Free
            </a>
          </div>
        </section>
        ...
        <script dangerouslySetInnerHTML={{
          __html: `
            console.log('CubiQo Web Portal - Static HTML Version');
            console.log('Correct content loaded');
          `
        }} />
      </body>
    </html>
